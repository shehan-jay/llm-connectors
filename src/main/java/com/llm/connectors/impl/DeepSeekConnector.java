...
/**
 * Connector implementation for DeepSeek AI API.
 */
public class DeepSeekConnector extends AbstractLLMConnector {
    private static final String API_VERSION = "v1";
    private static final String CHAT_ENDPOINT = "/chat/completions";
    private static final MediaType JSON = MediaType.parse("application/json; charset=utf-8");

    public DeepSeekConnector() {
        super();
    }
    ...
    public CompletableFuture<String> sendPrompt(String prompt, Map<String, Object> parameters) {
        ...
        ObjectNode requestBody = objectMapper.createObjectNode()
                .put("model", parameters.getOrDefault("model", "deepseek-chat").toString())
